  ...
  useEffect(() => {
    if (deviceApiData.length > 0 && positionApiData.length > 0) {
      ...
      const merged = deviceApiData.map(device => {
        const position = positionApiData.find(pos => pos.deviceId === device.id);
  ...
  return (
    <>
      ...
      {/* <VehicleDetails /> */}
        ...
        {component === 'AssetsCategory' && <AssetsCategory data={mergedData}/> }
        {component === 'DriverAssignmentReport' && <DriverAssignmentReport data={mergedData}/> }
        {component === 'AnalyticsDashboard' && <AnalyticsDashboard data={mergedData}/> }
        ...
        {component === 'CreateLandmark' && <CreateLandmark data={mergedData}/> }
        ...
        {component === 'AssetsDivision' && <AssetsDivision data={mergedData}/> }
        {component === 'AssetsOwner' && <AssetsOwner data={mergedData}/> }
        {component === 'AddressBook' && <AddressBook data={mergedData}/> }
        {component === 'AddressBookGroup' && <AddressBookGroup data={mergedData}/> }
        ...
        {component === 'DeviceSettings' && <DeviceSettings data={mergedData}/> }
        ...
        {component === 'ImportLocation' && <ImportLocation data={mergedData}/> }
        {component === 'LandmarkGroup' && <LandmarkGroup data={mergedData}/> }
        {component === 'LandmarkImages' && <LandmarkImages data={mergedData}/> }
        {component === 'LandmarkWaypoints' && <LandmarkWaypoints data={mergedData}/> }
        {component === 'MainMenuMaster' && <MainMenuMaster data={mergedData}/> }
        {component === 'RFID' && <RFID data={mergedData}/> }
        {component === 'TelecomMaster' && <TelecomMaster data={mergedData}/> }
        {component === 'TopMainMenuMaster' && <TopMainMenuMaster data={mergedData}/> }
        {component === 'TopMenuMaster' && <TopMenuMaster data={mergedData}/> }
        {component === 'UserMenuMaster' && <UserMenuMaster data={mergedData}/> }
        {component === 'UserProfile' && <UserProfile data={mergedData}/> }
        {component === 'UsersAssetsMapping' && <UsersAssetsMapping data={mergedData}/> }
        ...
        <BasicSpeedDial />
        {!['Dashboard', 'DistanceReport', 'Assets', 'AssetsCategory', 
          'DriverAssignmentReport', 'AnalyticsDashboard','AssetsType',
          'AssetsCommand','AssetsClass','AssetsGroup','Users','CreateLandmark',
          'EditLandmarks','CreateRoute','EditRoutes','CreateArea','AssetsDivision',
          'AssetsOwner','AddressBook','AddressBookGroup','AssetsURL','Broker',
          'Commands','DeviceSettings','DriverMaster','Emails','GeoData','ImportLocation',
          'LandmarkGroup','LandmarkImages','LandmarkWaypoints','MainMenuMaster','RFID',
          'TelecomMaster','TopMainMenuMaster','TopMenuMaster','UserMenuMaster','UserProfile',
          'UsersAssetsMapping','CreateArea','EditAreas','EditZones','Trips'].includes(component) && <Tablee data={mergedData}/>}
        </div>
      </div>
    </>
  );
